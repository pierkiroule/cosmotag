const TreeCanvas = ({ children, showAura }) => {
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      <div className="celestial-rings" aria-hidden="true" />
      ...
      <div className="floating-fireflies" aria-hidden="true" />
      <div className="floating-fireflies floating-fireflies--slow" aria-hidden="true" />
